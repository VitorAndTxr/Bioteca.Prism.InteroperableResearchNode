...
namespace Bioteca.Prism.Data.Migrations
{
    ...
    [Migration("20251005154530_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bioteca.Prism.Domain.Entities.Node.RegisteredNode", b =>
                {
                    ...
                    b.HasIndex("CertificateFingerprint")
                        .IsUnique()
                        .HasDatabaseName("ix_registered_nodes_certificate_fingerprint");

                    b.HasIndex("LastAuthenticatedAt")
                        .HasDatabaseName("ix_registered_nodes_last_authenticated_at");

                    b.HasIndex("NodeAccessLevel")
                        .HasDatabaseName("ix_registered_nodes_access_level");

                    b.HasIndex("RegisteredAt")
                        .HasDatabaseName("ix_registered_nodes_registered_at");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_registered_nodes_status");

                    b.ToTable("registered_nodes", (string)null);
                });
