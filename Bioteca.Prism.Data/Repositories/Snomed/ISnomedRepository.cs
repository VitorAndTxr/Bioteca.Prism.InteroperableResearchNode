...
/// </summary>
public interface ISnomedLateralityRepository : IRepository<SnomedLaterality, string>
{
    /// <summary>
...
/// </summary>
public interface ISnomedTopographicalModifierRepository : IRepository<SnomedTopographicalModifier, string>
{
    /// <summary>
...
/// </summary>
public interface ISnomedBodyRegionRepository : IRepository<SnomedBodyRegion, string>
{
    /// <summary>
...
/// </summary>
public interface ISnomedBodyStructureRepository : IRepository<SnomedBodyStructure, string>
{
    /// <summary>
